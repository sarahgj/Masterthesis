...
if strcmp(type, 'methyliodide')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/released_methyliodide_M91.dat',mass(positive_index), '\t') 

elseif strcmp(type, 'dibromomethane')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/released_dibromomethane_M91.dat',mass(positive_index), '\t') 

elseif strcmp(type, 'bromoform')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/released_bromoform_M91.dat',mass(positive_index), '\t') 
end
...
for i = 1:len
    if (mass(i) > 0)     
        ...
        elseif strcmp(type, 'dibromomethane')
            ...
            fprintf(fid_2, '3600            SSSSS             SAMPLING RATE OF OUTPUT (IN SSSSS SECONDS) \n');
            fprintf(fid_2, '999999999       SSSSSSS           TIME CONSTANT FOR PARTICLE SPLITTING (IN SECONDS) \n');
            fprintf(fid_2, '3600            SSSSS             SYNCHRONISATION INTERVAL OF FLEXPART (IN SECONDS) \n');
        end
