...
infile = xlsread('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/M91_corrected_fluxes_Alina');

%reading the fluxes and setting the right molare masse
if strcmp(type, 'methyliodide')
    emissions = infile(:,20); % [pmol/(m²*hr)]
    molm = 0.14194;           % Molare Masse [kg/mol]
elseif strcmp(type, 'dibromomethane')
    emissions = infile(:,21); % [pmol/(m²*hr)]
    molm = 0.17383;           % Molare Masse [kg/mol]    
elseif strcmp(type, 'bromoform')
    emissions = infile(:,22); % [pmol/(m²*hr)]
...
measuredates = datenum(2012, 12, day, hour, 0, 0);
...
if strcmp(type, 'methyliodide')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Fluxes/fluxes_Methyliodide_M91_F10.dat',flux, '\t') 
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Fluxes/all_dates_Methyliodide_M91_F10.dat',measuredates_string, '') 
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Fluxes/all_lats_Methyliodide_M91_F10.dat',lat, '\t')   
elseif strcmp(type, 'dibromomethane')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Fluxes/fluxes_Dibromomethane_M91_F548.dat',flux, '\t') 
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Fluxes/all_dates_Dibromomethane_M91_F548.dat',measuredates_string, '')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Fluxes/all_lats_Dibromomethane_M91_F548.dat',lat, '\t')
elseif strcmp(type, 'bromoform')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Fluxes/fluxes_Bromoform_M91_F92.dat',flux, '\t') 
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Fluxes/all_dates_Bromoform_M91_F92.dat',measuredates_string, '')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Fluxes/all_lats_Bromoform_M91_F92.dat',lat, '\t')
end
...
%xlabel('Date');
%ylabel('Flux');
%saveas(figure(1), ['/uio/hume/student-u17/sarahgj/Master/Figures/VSLS/Fluxes/M91_', type],'pdf')
...
%open file to write released mass
if strcmp(type, 'methyliodide')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Released/released_Methyliodide_M91_F10.dat',mass(positive_index), '\t') 
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Released/dates_Methyliodide_M91_F10.dat',measuredates_string(positive_index,:), '') 
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Released/lats_Methyliodide_M91_F10.dat',lat(positive_index), '\t')
elseif strcmp(type, 'dibromomethane')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Released/released_Dibromomethane_M91_F548.dat',mass(positive_index), '\t') 
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Released/dates_Dibromomethane_M91_F548.dat',measuredates_string(positive_index,:), '')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Released/lats_Dibromomethane_M91_F548.dat',lat(positive_index), '\t')
elseif strcmp(type, 'bromoform')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Released/released_Bromoform_M91_F92.dat',mass(positive_index), '\t') 
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Released/dates_Bromoform_M91_F92.dat',measuredates_string(positive_index,:), '') 
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/Released/lats_Bromoform_M91_F92.dat',lat(positive_index), '\t')
end


%% Writing FLEXPART files
j = 0;
for i = 1:len
    if (mass(i) > 0)     
        j = j+1;    
        ...
        %open file to write
        if strcmp(type, 'methyliodide')
           fid = fopen(['/uio/hume/student-u17/sarahgj/Master/Data/Flexpart_files/M91/Methyliodide/RELEASES-' istr], 'wt');
        elseif strcmp(type, 'dibromomethane')
           fid = fopen(['/uio/hume/student-u17/sarahgj/Master/Data/Flexpart_files/M91/Dibromomethane/RELEASES-' istr], 'wt');
        elseif strcmp(type, 'bromoform')
           fid = fopen(['/uio/hume/student-u17/sarahgj/Master/Data/Flexpart_files/M91/Bromoform/RELEASES-' istr], 'wt');
        else
        ...
        %   fprintf(fid, '                                                                         \n');
        %   fprintf(fid, '                                                                         \n'); 
        fprintf(fid, 'M91cruice_01-26_Dec_V%2i                                                 \n', i);
        ...
        %WRITE COMMAND
        if strcmp(type, 'methyliodide')
           fid_2 = fopen(['/uio/hume/student-u17/sarahgj/Master/Data/Flexpart_files/M91/Methyliodide/COMMAND-' istr], 'wt');
        elseif strcmp(type, 'dibromomethane')
           fid_2 = fopen(['/uio/hume/student-u17/sarahgj/Master/Data/Flexpart_files/M91/Dibromomethane/COMMAND-' istr], 'wt');
        elseif strcmp(type, 'bromoform')
           fid_2 = fopen(['/uio/hume/student-u17/sarahgj/Master/Data/Flexpart_files/M91/Bromoform/COMMAND-' istr], 'wt');
        else
            fprintf('Thats wierd :O')
        end
