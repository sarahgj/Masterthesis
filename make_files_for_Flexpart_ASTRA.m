...
if strcmp(type, 'methyliodide')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/released_methyliodide_ASTRA.dat',mass(positive_index), '\t') 

elseif strcmp(type, 'dibromomethane')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/released_dibromomethane_ASTRA.dat',mass(positive_index), '\t') 

elseif strcmp(type, 'bromoform')
   dlmwrite('/uio/hume/student-u17/sarahgj/Master/Data/VSLS_measurements/released_bromoform_ASTRA.dat',mass(positive_index), '\t') 
end
